...
def PesudoLabel(args, backbone, classifier, train_loader, test_loader, backbone_optimizer, backbone_scheduler):
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, instance in enumerate(train_loader):
            ...
            # print(outputs)
            _, pesudo_labels = outputs.max(1)
            # print(pesudo_labels)
            
            loss = nn.CrossEntropyLoss()(outputs, pesudo_labels)
            # print(loss)
